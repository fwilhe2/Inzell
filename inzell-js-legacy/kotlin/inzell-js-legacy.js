(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'inzell-js-legacy'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'inzell-js-legacy'.");
    }
    root['inzell-js-legacy'] = factory(typeof this['inzell-js-legacy'] === 'undefined' ? {} : this['inzell-js-legacy'], kotlin);
  }
  ...
  Kotlin.defineModule('inzell-js-legacy', _);
  return _;
}));

//# sourceMappingURL=inzell-js-legacy.js.map
